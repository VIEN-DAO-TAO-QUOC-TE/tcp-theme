...
<div class="widget_shopping_cart">
    <div class="widget_shopping_cart_content">
        <div class="cart-popup-title">
            <span class="cart-popup-title__heading"><?php _e('Cart', 'woocommerce'); ?> <span class="cart-popup-title__amount"><?php echo  ' (' . WC()->cart->get_cart_contents_count() . ')'; ?></span></span>
        </div>
        <div class="widget_shopping_cart">
            <div class="widget_shopping_cart_content">
                ...
                <?php if (WC()->cart && ! WC()->cart->is_empty()) : ?>
                        ...
                        ?>
                                <li class="woocommerce-mini-cart-item <?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key)); ?>">
                                    ...
                                    echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                        ...
                                        sprintf(
                                            '<a role="button" href="%s" class="remove remove_from_cart_button icon-trash-2" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s" data-success_message="%s"></a>',
                    ...
                    <div class="ux-mini-cart-footer">
                        ...
                        <p class="woocommerce-mini-cart__total">
                            <?php
                            do_action('woocommerce_widget_shopping_cart_total_custom');
                            ?>
                        </p>
