...
<div class="c-thankyou">
	<div class="c-thankyou__inner container">
		...
		<?php if ($order) : ?>
			...
			<?php else : ?>
				...
				<?php
				// Render via service (preferred)
				if (class_exists('\TCP\Theme\Services\Checkout\ThankYouService')) {
					\TCP\Theme\Services\Checkout\ThankYouService::instance()->render($order);
				} else {
					// Fallback
					?>
