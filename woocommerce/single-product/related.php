...
if ( $related_products ) :
	...
	<div class="related related-products-wrapper product-section">
		...
		<?php
		$heading = apply_filters( 'woocommerce_product_related_products_heading', __( 'Những khóa học có thể  quan tâm', 'woocommerce' ) );

		if ( $heading ) :
			?>
            <div class="product-section-title-related__eyebrow"><?php echo __('Cùng chủ đề')?></div>
